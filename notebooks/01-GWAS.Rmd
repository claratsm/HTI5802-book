...
:green_book: **Q1:** How many SNPs are there?
```bash
wc -l chrAll.ASA.bim
```
:green_book: **Q2:** Where are these SNPs located?
```bash
...
:green_book: **Q3:** How many samples are there?

:green_book: **Q4:** Any sample belongs to the same family?
...
:closed_book: **Q:** Can you try to plot the right number of excluded samples?<br>
<details>
...
```
:closed_book: **Q5:** What is the most likely karyotype for the **id2_669** sample and what disease may he/she have?
...
```
:closed_book: **Q6:** Which sample(s) looks like having contamination?
...
```
:closed_book: **Q7:** How are the samples in CHSQUAD family related?
...
:closed_book: **Q9:** How many cornoary artery disease (CAD) patients and controls are there in this dataset?<br>

:closed_book: **Q.** Is the low density lipoprotein (LDL) level normally distributed?
<details>
<summary> Answer </summary>
...
:closed_book: **Q.** Is there any relationship between age, LDL level and CAD?
<details>
<summary> Answer </summary>
...
:closed_book: **Q10:** Which SNP is the top SNP? Can you give the effect size and the confidence interval (CI)?

:closed_book: **Q.** What is the lamda? Does it indicate inflation of the association statistics?
<details>
  <summary> Answer </summary>
...
- To perform logistic regression without adjusting for age
```bash 
~/plink --bfile chrAll.ASA.afterSampleQC.afterVariantQC \
 --chr 1-22,X,XY \
